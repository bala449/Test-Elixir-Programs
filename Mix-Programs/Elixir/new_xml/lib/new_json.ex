defmodule NewJson do
  ...
  def filter_data(data) do
    ...
    result = Map.split(data, [data["TransactionArray"]["Transaction"]["QuantityPurchased"],
             data["Item"]["ItemID"], data["Item"]["Seller"]["UserID"], data["Item"]["Title"],
             data["TransactionArray"]["Transaction"]["CreatedDate"]])
